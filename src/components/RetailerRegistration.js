                ...
                <form className='Auth-form' onSubmit={e => validate(e)}>
                    <div className='Auth-form-content'>
                        ...
                        <div className='form-group mt-3'>
                            <input className='form-control mt-1 input' type="text" id="retailerName" placeholder='Retailer Name' onChange={(e) => setRetName(e) }/>
                        </div>
                        <div className='form-group mt-3'>
                            <input className='form-control mt-1 input' type="text" id="retailerEmail" placeholder='Email' onChange={(e) => setRetEmail(e) }/>
                        </div>
                        <div className='form-group mt-3'>
                            <input className='form-control mt-1 input' type="password" id="retailerPassword" autoComplete="on" placeholder='Password' onChange={(e) => setRetPass(e) }/>
                        </div>
                        
                        <div className='form-group mt-3'>
                            <input className='form-control mt-1 input' type="text" id="retailerPhone" placeholder='Phone' onChange={(e) => setRetPhone(e) }/>
                        </div>
                        <div className='form-group mt-3'>
                            <input className='form-control mt-1 input' type="text" id="retailerAddress" placeholder='Address' onChange={(e) => setRetAddress(e) }/>
                        </div>
                        <div className='form-group mt-3'>
                            <input className='form-control mt-1 input' type="text" id="retailerPincode" placeholder='Pincode' onChange={(e) => setRetPin(e) }/>
                        </div>
